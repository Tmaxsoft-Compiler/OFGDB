/* Cobol language support routines for GDB, the GNU debugger.
...
extern void _initialize_cobol_language (void);
...
void
cobol_emit_char (int c, struct type *type,
...
void
cobol_printchar (int c, struct type *type, struct ui_file *stream)
{
...
void
cobol_printstr (struct ui_file *stream, struct type *type, 
...
void
cobol_get_string (struct value *value, gdb_byte **buffer,
...
/* Expression evaluator for the COBOL language family.  Most operations
   are delegated to evaluate_subexp_standard; see that function for a
   description of the arguments.  */

struct value *
evaluate_subexp_cobol (struct type *expect_type, struct expression *exp,
		   int *pos, enum noside noside)
{
  ...
  return evaluate_subexp_standard (expect_type, exp, pos, noside); /* sylee test */
}
...
const struct op_print cobol_op_print_tab[] =
{
...
void
cobol_language_arch_info (struct gdbarch *gdbarch,
...
const struct exp_descriptor exp_descriptor_cobol = 
{
  ...
  evaluate_subexp_cobol /* sylee test */
};
...
const struct language_defn cobol_language_defn =
{
  "cobol",			/* Language name */
  "COBOL",
  language_cobol,
  ...
  array_row_major,
  macro_expansion_c,
  &exp_descriptor_cobol, /* sylee */
  cobol_parse,
  c_error,
  null_post_parser,
  cobol_printchar,			/* Print a character constant */
  c_printstr,			/* Function to print string constant */
  cobol_emit_char,			/* Print a single char */
  c_print_type,			/* Print a type using appropriate syntax */
  c_print_typedef,		/* Print a typedef using appropriate syntax */
  cobol_val_print,			/* Print a value using appropriate syntax */
  cobol_value_print,		/* Print a top-level value */
  default_read_var_value,	/* TODO check : la_read_var_value */
  ...
  cobol_op_print_tab,		/* expression operators for printing */
  1,				/* c-style arrays */
  ...
  &c_varobj_ops,	/* TODO check */
  LANG_MAGIC
};

void
_initialize_cobol_language (void)
{
  add_language (&cobol_language_defn);
}
